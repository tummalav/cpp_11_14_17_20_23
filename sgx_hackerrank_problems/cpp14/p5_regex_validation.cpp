// Problem 5: Regex Validation | C++14
/*
...
*/
// C++14: generic lambda for printing, digit separator, [[deprecated]] attr
#include <string>
#include <regex>
#include <iostream>
using namespace std;
int main() {
    ...
    cin.tie(nullptr);
    // C++14: regex_constants::optimize available in C++11 but shown here explicitly
    const regex re(R"(^([ab])([ab]*\1)?$)",
                   regex_constants::ECMAScript | regex_constants::optimize);
    // C++14: generic lambda for output
    auto print = [](auto val){ cout << val << '\n'; };
    int query; cin >> query;
    while (query--) {
        string s; cin >> s;
        print(regex_match(s, re) ? "True" : "False");
    }
    return 0;
}
