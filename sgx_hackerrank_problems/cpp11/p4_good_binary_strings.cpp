// =============================================================================
// Problem 4: Good Binary Strings  |  C++11
...
// =============================================================================
// C++11 features:
//   - Lambda with explicit return type for sort comparator
//   - auto, range-based for, move semantics
//   - emplace_back
// =============================================================================
#include <string>
#include <vector>
...
string largestMagical(const string& s) {
    if (s.empty()) return string();      // C++11: explicit empty string
    ...
    // Recursively process inner of each primitive
    for (auto& p : parts) {              // C++11: range-based for with reference
        if (p.size() > 2) {
            string inner = p.substr(1, p.size() - 2);
            string inner_sorted = largestMagical(inner);
            p = "1" + inner_sorted + "0";
        }
    }

    // Sort descending – C++11 lambda with explicit return type
